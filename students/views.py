...
def student_dashboard(request):
    ...
    # Update the field name based on the Notice model
    notices = Notice.objects.all().order_by('-created_at')[:5].select_related('posted_by')  # Change 'posted_at' to 'created_at' or correct field
